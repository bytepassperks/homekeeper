...
import { Home, Shield, Calendar, Bell, FileText, Smartphone, TrendingUp, Users, Star, CheckCircle, AlertCircle, Trophy, Zap, Target, Mail, Twitter, Linkedin, Instagram, ExternalLink, DollarSign, HelpCircle, BookOpen, ArrowRight, BarChart3, Sparkles } from 'lucide-react';
...
interface LandingPageProps {
  onGetStarted: () => void;
  onNavigate?: (page: 'pricing' | 'faq' | 'blog' | 'brand' | 'privacy' | 'terms' | 'cookies' | 'refund') => void;
}
